...
7) Depending upon how you will handle multimedia files run one of the commands below:
  - node 04_multimedia_init.js
...
10) If you haven't already, update the VAL Vermont Registry of Names. The next steps will upload and ingest occurrences. This is a time-consuming process.
    You should only need to ingest occurrences once per time-period, but you will need the latest names to do that.
...
11) Prepare and upload zipped DwCA files to gbif-split directory on VAL Core server:
  ...
  - Create a new gbif-split directory. chmod 777 gbif-split. chown tomcat7.tomcat7 gbif-split.
